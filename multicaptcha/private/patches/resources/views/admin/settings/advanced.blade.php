                        ...
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small">If enabled, login forms and password reset forms require a CAPTCHA check.</p>
                                </div>
                            </div>
                            <div class="form-group col-md-3">
                                <label class="control-label">Provider</label>
                                <div>
                                    @php($provider = old('recaptcha:provider', config('recaptcha.provider', 'google')))
                                    <select class="form-control" name="recaptcha:provider">
                                        <option value="google" @if($provider === 'google') selected @endif>Google reCAPTCHA</option>
                                        <option value="turnstile" @if($provider === 'turnstile') selected @endif>Cloudflare Turnstile</option>
                                        <option value="hcaptcha" @if($provider === 'hcaptcha') selected @endif>hCaptcha</option>
                                    </select>
                                    <p class="text-muted small">Choose which CAPTCHA provider the panel should use.</p>
                                </div>
                            </div>
                            <div class="form-group col-md-3">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small">Used for communication between your site and the selected CAPTCHA provider.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="alert alert-warning no-margin">
                                        You are currently using default CAPTCHA keys shipped with this Panel. For improved security, generate keys tied specifically to your website.
                                    </div>
                                </div>
                            </div>
                        @endif
